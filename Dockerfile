...
CMD ["sh", "-c", "python -m engine.ingest.load_sailings ; exec python -m streamlit run app.py --server.port 8080 --server.address 0.0.0.0 --server.headless true --server.enableCORS false --server.enableXsrfProtection false"]
